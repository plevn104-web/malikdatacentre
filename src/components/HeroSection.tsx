...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen overflow-hidden" style={{ backgroundImage: `url(${heroBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-background/80" />
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Floating orbs */}
        <div className="floating absolute left-[10%] top-[20%] h-64 w-64 rounded-full bg-primary/10 blur-3xl" />
        <div className="floating-delayed absolute right-[15%] top-[30%] h-80 w-80 rounded-full bg-secondary/10 blur-3xl" />
        <div className="floating-slow absolute bottom-[20%] left-[30%] h-48 w-48 rounded-full bg-primary/5 blur-2xl" />
      ...
      <div className="container relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-20">
        ...
        >
          <div className="glass-card inline-flex items-center gap-2 px-4 py-2">
            ...
            <span className="text-sm text-muted-foreground">HAMZA AI TOOLS AND SERVICES</span>
          </div>
        </motion.div>
