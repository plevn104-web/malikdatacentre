      ...
      <div className="container flex h-16 items-center justify-between px-4 md:h-20">
        ...
        <a href="/" className="flex items-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary">
            <span className="font-display text-lg font-bold text-primary-foreground">AI</span>
          </div>
          <div className="hidden sm:block">
            <span className="font-display text-lg font-bold text-foreground">Institute of AI</span>
          </div>
        </a>
