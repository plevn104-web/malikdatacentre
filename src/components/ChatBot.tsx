...
export const ChatBot = () => {
  ...
  return (
    <>
      {/* Chatbot toggle button - lightweight */}
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
          >
            <div className="relative flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-card/80 backdrop-blur-md border border-border/50 shadow-[0_4px_20px_hsl(var(--primary)/0.15)] hover:shadow-[0_6px_28px_hsl(var(--primary)/0.25)] transition-all duration-300">
              <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary">
              ...
              <div className="flex flex-col items-start">
                <span className="text-sm font-semibold text-foreground whitespace-nowrap">Ask AI Assistant</span>
                <span className="text-[10px] text-muted-foreground whitespace-nowrap">Tools • Courses • Support</span>
              </div>
            </div>
          </motion.button>
        )}
